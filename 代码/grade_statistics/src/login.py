...
class Ui_MainWindow(object):
    ...
    def retranslateUi(self, MainWindow):
        ...
        MainWindow.setWindowTitle(_translate("MainWindow", "管理员登录 - 智慧校园-学生成绩管理系统"))
        self.label.setText(_translate("MainWindow", "智慧校园-学生成绩管理系统"))
        ...
        self.label_4.setText(_translate("MainWindow", "2021软件工程-邓康组"))
        self.label_5.setText(_translate("MainWindow", "组员：张雨舟等"))
    ...
    def btn_clicked(self,MainWindow):
        ...
        if len(result) == 0:
            ...
            gl.LOGIN_WINDOW = aw
            MainWindow.hide()
            self.main.setWindowTitle('智慧校园-学生成绩管理系统')
        print(result)
...
if __name__ == "__main__":
    ...
    w.show()  # 显示主窗体
    w.setWindowTitle('管理员登录 - 智慧校园-学生成绩管理系统')
